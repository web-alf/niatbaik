// SVG icon set. Ported from icons.jsx → named export.
...
export function Icon({ name, size = 18, className = '', strokeWidth = 1.8 }: IconProps) {
  ...
  const base = { fill: 'none', stroke: 'currentColor', strokeWidth, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const };
  const paths: Record<string, ReactNode> = {
    ...
    pray: <><path d="M12 3v7"/><path d="M9 10l-3 4c-1 1.5-1 3 0 4l3 2 3-2 3-2c1-1 1-2.5 0-4l-3-4"/><path d="M12 10V6"/></>,
    ...
    // Official WhatsApp brand mark (filled, simple-icons path) — used in the share
    // menu, footer contact link, and CS/WA buttons.
