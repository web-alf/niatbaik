<x-dashboard-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.pages.create') }}" class="bg-green-600 text-white rounded-lg px-6 py-2 text-sm font-medium hover:bg-green-700 transition">Buat Page</a>
        </div>
    </x-slot>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50"><tr>
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-600">Slug</th>
