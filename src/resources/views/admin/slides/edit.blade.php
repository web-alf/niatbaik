        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form method="POST" action="{{ route('admin.slides.update', $slide) }}" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div><label for="link" class="block text-sm font-medium text-gray-700 mb-1">Link (opsional)</label><input type="text" name="link" id="link" value="{{ old('link', $slide->link) }}" placeholder="https://..." class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500"></div>
