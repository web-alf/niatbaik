            ...
            <form action="{{ route('dashboard.campaigns.update', $campaign) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $campaign->title) }}" required class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">
                        <x-input-error :messages="$errors->get('title')" class="mt-1" />
                    </div>
                    <div>
                        <label for="short_description" class="block text-sm font-medium text-gray-700 mb-1">Deskripsi Singkat</label>
                        <input type="text" name="short_description" id="short_description" value="{{ old('short_description', $campaign->short_description) }}" class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="8" required class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">{{ old('description', $campaign->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="target" id="target" value="{{ old('target', $campaign->target) }}" min="0" class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="duration_days" id="duration_days" value="{{ old('duration_days', $campaign->duration_days) }}" min="1" class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">
