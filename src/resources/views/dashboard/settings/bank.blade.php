            ...
            <form action="{{ route('dashboard.settings.bank.update') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="bank_type" id="bank_type" value="{{ old('bank_type', $user->bank_type) }}" required placeholder="BCA, BNI, Mandiri, dll" class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_number" id="bank_number" value="{{ old('bank_number', $user->bank_number) }}" required class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $user->bank_name) }}" required class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
