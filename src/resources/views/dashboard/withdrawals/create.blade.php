            ...
            <form action="{{ route('dashboard.withdrawals.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="amount" id="amount" value="{{ old('amount') }}" min="10000" required class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                        <x-input-error :messages="$errors->get('amount')" class="mt-1" />
                    </div>
                    <div>
                        <label for="campaign_id" class="block text-sm font-medium text-gray-700 mb-1">Campaign</label>
                        <select name="campaign_id" id="campaign_id" class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_type" id="bank_type" value="{{ old('bank_type', auth()->user()->bank_type) }}" required placeholder="BCA, BNI, Mandiri, dll" class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_number" id="bank_number" value="{{ old('bank_number', auth()->user()->bank_number) }}" required class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', auth()->user()->bank_name) }}" required class="w-full rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500">
